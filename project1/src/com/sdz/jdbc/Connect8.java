...
public class Connect8 extends JFrame {
  ...
  */
  public void initTable(String query){
    ...
    //On crée un statement
      ...
      Statement state = JDBCConnect.getInstance().createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
